...
export const createUserDataRef = (dcOrVars, vars) => {
...
export function createUserData(dcOrVars, vars) {
  const { dc: dcInstance, vars: inputVars } = validateArgs(connectorConfig, dcOrVars, vars, true);
...
export const deleteUserDataRef = (dcOrVars, vars) => {
  const { dc: dcInstance, vars: inputVars} = validateArgs(connectorConfig, dcOrVars, vars, true);
  dcInstance._useGeneratedSdk();
...
export function deleteUserData(dcOrVars, vars) {
  const { dc: dcInstance, vars: inputVars } = validateArgs(connectorConfig, dcOrVars, vars, true);
  return executeMutation(deleteUserDataRef(dcInstance, inputVars));
}

export const listUserDataRef = (dc) => {
...
export function listUserData(dcOrOptions, options) {
